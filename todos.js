...
// [J̩r̫me Gravel-Niquet](http://jgn.me/). This demo uses a simple
...
//What follows is standard Facebook JS initialization.  See Facebook for more details.
  ...
  window.fbAsyncInit = function() {
    FB.init({
      appId      : '320350694720910', // FB App ID
...
// Stackmob code for models and collections
...
var Todos = StackMob.Collection.extend({
  ...
  var LoginView = Backbone.View.extend({
    ...
    events: {
    	'click #login_new' : 'login_new',
    	'click #login_existing' : 'login_existing',
    	'click #login_native' : 'login_native',
    ...
    render: function() {
      ...
      $(this.el).html(this.template({"loginstatus" : StackMob.getLoggedInUser()}))
      return this;
    },
    
    login_new: function()	{loginNew()},
	  
    login_existing: function()	{loginExisting()},
    
    login_native: function()	{loginNative()},
    
    log_out: function()	{logOut()},
